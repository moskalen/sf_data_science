...
# Пути к файлам
RECS_PATH = "models/recommendations_lightgbm_top3.csv"
...
print(f"Precision@3 (LightGBM): {precision_at_3:.4f}")
...
top3 = (
    recommendations.sort_values(by=["visitorid", "purchase_proba"], ascending=[True, False])
    .groupby("visitorid")
...
print(f"Precision@3 (Random Forest Global): {precision_at_3:.4f}")
